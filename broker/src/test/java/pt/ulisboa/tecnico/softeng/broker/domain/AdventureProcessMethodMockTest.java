...
public class AdventureProcessMethodMockTest {
	...
	@Test
	public void processBankException(@Mocked final BankInterface bankInterface){
		new Expectations(){{
			BankInterface.processPayment(IBAN,300);
	...
	@Test
	public void processHotelException(@Mocked final BankInterface bankInterface,
									  @Mocked final HotelInterface hotelInterface, @Mocked final ActivityInterface activityInterface) {
		new Expectations(){{
			BankInterface.processPayment(IBAN, 300);
			this.result = PAYMENT_CONFIRMATION;
	...
	@Test
	public void processActivityException(@Mocked final BankInterface bankInterface,
									  @Mocked final HotelInterface hotelInterface, @Mocked final ActivityInterface activityInterface) {
		new Expectations(){{
			BankInterface.processPayment(IBAN, 300);
			this.result = PAYMENT_CONFIRMATION;
